...
<template>
  ...
  <main class="dashboard">
    ...
    <template v-else>
      ...
      <CustomizationPanel :custom="s.customCategories.value" :category-rules="s.categoryRules.value" :excluded-domains="s.excludedDomains.value" @changed="() => s.load({ silent: true })" />
      </section>
    </template>
  </main>
